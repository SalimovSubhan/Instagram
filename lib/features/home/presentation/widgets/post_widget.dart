...
class PostWidget extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final scaleAnimation = Tween(begin: 1.0, end: 1.3)
        .animate(CurvedAnimation(parent: likeAnimation, curve: Curves.easeOut));
              ...
              Row(
                ...
                children: [
                      ...
                      Column(
                        children: [
                          ScaleTransition(
                            ...
                            child: IconButton(
                              onPressed: () async {
                                await likeAnimation.forward();
                                await likeAnimation.reverse();
                                await ref
                              ...
                              icon: Icon(
                                ...
                                color:
                                    item.postLike ? Colors.red : Colors.black,
                              ),
                            ),
                          ),
                  ...
                  IconButton(
                    ...
                    icon: Icon(
                      item.postFavorite ? Icons.turned_in : Icons.turned_in_not,
                    ),
                  ),
                ],
              ),
