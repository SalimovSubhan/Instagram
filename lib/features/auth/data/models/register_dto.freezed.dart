...
class _$RegisterDtoImpl implements _RegisterDto {
  ...
  @override
  String toString() {
    return 'RegisterDto(userName: $userName, fullName: $fullName, email: $email, password: $password, confirmPassword: $confirmPassword)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, userName, fullName, email, password, confirmPassword);
...
abstract class _RegisterDto implements RegisterDto {
  factory _RegisterDto(
      ...
      final String? email,
      final String? password,
      final String? confirmPassword}) = _$RegisterDtoImpl;
